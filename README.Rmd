...
- Laila Viana - https://curso-r.github.io/202203-r4ds-1/trabalhos_premiados/Laila_Viana/index.html

- Irene Slusarz - https://curso-r.github.io/202203-r4ds-1/trabalhos_premiados/Irene_Slusarz/
...
knitr::kable(
  tibble::tibble(
    ...
    script = list.files(pasta, full.names = TRUE),
    link = paste0(
...
knitr::kable(
  tibble::tibble(
    #script = CursoRopen:::list_github_files(params$turma, pasta, ".R$"),
    script = list.files(pasta, full.names = TRUE, pattern = ".R$|.Rmd$" ),
    link = paste0(
      "https://raw.githubusercontent.com/curso-r/",
      params$turma,
      "/main/",
